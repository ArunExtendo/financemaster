...
//	Page<MCompanyDto> findAllBySearch(@Param("search") String search, Pageable paging);
	...
	@Query(value = "select c.compCode as compCode, c.compName as compName, c.compBaseCurrCode1 as compBaseCurrCode1," +
			" c.compBaseCurrCode2 as compBaseCurrCode2,c.compBaseCurrCode3 as compBaseCurrCode3, " +
			" c.compRoundOff as compRoundOff, c.compUnitName as compUnitName " +
			" from MCompany c  " +
			" where upper( c.compCode || c.compName || c.compBaseCurrCode1 || c.compBaseCurrCode2 || c.compBaseCurrCode3  " +
			" || c.compUnitName  || c.compRoundOff ) " +
			" like upper(:search)")
	Page<MCompanyDto> findAllBySearch(@Param("search") String search, Pageable paging);
