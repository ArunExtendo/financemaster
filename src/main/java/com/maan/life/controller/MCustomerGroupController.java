...
@RequestMapping("/mcustomerGroup")
public class MCustomerGroupController {
	...
	private static final Logger logger = Logger.getLogger(MCustomerGroupController.class);

	@ApiOperation(value = "API to Create or Update Customer group Entity.", response = Response.class)
